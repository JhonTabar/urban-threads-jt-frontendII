    ...
    <footer className="urban-gradient text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-xl font-bold mb-4">URBAN THREADS</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><Link to="/productos" className="hover:text-amber-400 transition-colors">Productos</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><Link to="/guia-tallas" className="hover:text-amber-400 transition-colors">Guía de tallas</Link></li>
              <li><Link to="/envios" className="hover:text-amber-400 transition-colors">Envíos</Link></li>
              <li><Link to="/devoluciones" className="hover:text-amber-400 transition-colors">Devoluciones</Link></li>
